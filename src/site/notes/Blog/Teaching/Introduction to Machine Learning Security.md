---
{"dg-publish":true,"dg-path":"Teaching/Introduction to Machine Learning Security.md","permalink":"/teaching/introduction-to-machine-learning-security/","created":"2026-05-28T20:14:48.079+02:00","updated":"2026-05-28T20:14:48.079+02:00"}
---

# Table of Contents

1. [[Blog/Teaching/Introduction to Machine Learning Security#What Are These Notes About?\|#What Are These Notes About?]]
2. [[Blog/Teaching/Introduction to Machine Learning Security#What Are These Notes NOT About?\|#What Are These Notes NOT About?]]
3. [[Blog/Teaching/Introduction to Machine Learning Security#What Is a Machine Learning Model?\|#What Is a Machine Learning Model?]]
4. [[Blog/Teaching/Introduction to Machine Learning Security#Adversarial Machine Learning\|#Adversarial Machine Learning]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Robustness vs. Security\|#Robustness vs. Security]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Threats via the CIA Triad\|#Threats via the CIA Triad]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Attacks by Model Lifecycle Phase\|#Attacks by Model Lifecycle Phase]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#The Adversary Model\|#The Adversary Model]]
5. [[Blog/Teaching/Introduction to Machine Learning Security#Evasion\|#Evasion]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Mathematical Formalization\|#Mathematical Formalization]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Why Do Adversarial Examples Exist?\|#Why Do Adversarial Examples Exist?]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Defenses Against Evasion Attacks\|#Defenses Against Evasion Attacks]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Model-Agnostic Evasion Attack: Pre-processing Manipulation\|#Model-Agnostic Evasion Attack: Pre-processing Manipulation]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Large Language Models (LLMs) – Jailbreaking and Prompt Injection\|#Large Language Models (LLMs) – Jailbreaking and Prompt Injection]]
6. [[Blog/Teaching/Introduction to Machine Learning Security#Poisoning Attacks\|#Poisoning Attacks]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Targeted Poisoning\|#Targeted Poisoning]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Untargeted Poisoning\|#Untargeted Poisoning]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Feature Collision – A Sophisticated Attack Against Transfer Learning\|#Feature Collision – A Sophisticated Attack Against Transfer Learning]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Defenses Against Poisoning Attacks\|#Defenses Against Poisoning Attacks]]
7. [[Blog/Teaching/Introduction to Machine Learning Security#Backdoor Attacks\|#Backdoor Attacks]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Backdoor as Intentional Spurious Correlation\|#Backdoor as Intentional Spurious Correlation]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Backdoor vs. Evasion vs. Poisoning\|#Backdoor vs. Evasion vs. Poisoning]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Defenses Against Backdoor Attacks\|#Defenses Against Backdoor Attacks]]
8. [[Blog/Teaching/Introduction to Machine Learning Security#Availability Attacks\|#Availability Attacks]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Exploiting GPU Optimization\|#Exploiting GPU Optimization]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Sponge Examples\|#Sponge Examples]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Defenses Against Availability Attacks\|#Defenses Against Availability Attacks]]
9. [[Blog/Teaching/Introduction to Machine Learning Security#Confidentiality Attacks\|#Confidentiality Attacks]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Training Data Extraction\|#Training Data Extraction]]
	- [[Blog/Teaching/Introduction to Machine Learning Security#Model Stealing\|#Model Stealing]]
10. [[Blog/Teaching/Introduction to Machine Learning Security#Conclusion\|#Conclusion]]
